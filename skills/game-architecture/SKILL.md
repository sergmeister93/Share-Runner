...
**Title screen and score HUD.** Include a title/menu scene and an in-game score HUD by default. Display the player's current score (and any lives, timer, or level indicator) on screen during gameplay so the player can see their progress at all times.
